...
import {
  AssignmentTurnedIn, ErrorOutline,
  FactCheck,
  Groups,
  HowToReg,
  NotInterested,
...
export const StudentsAttendanceStep = (props) => {
  const {
    onBack, onNext, attendance, handleSendEmailToAbsents, handleMarkStudentAsAbsentJustify, handleSendEmailToStudent, handleMarkStudentAsAbsent, handleMarkStudentAsPresent, ...other
  } = props;
  return (
    <Container {...other}>
                    ...
                    <TableCell align="right">
                      {!student.present && (
                        <Tooltip title="Mark as justify">
                          <IconButton
                            ...
                            disabled={attendance?.data?.isLocked || student.justify}
                            component="a"
                          >
                      ...
                      {!student.present && (
                        <Tooltip title="Send attendance email">
                          <IconButton
                            disabled={attendance?.data?.isLocked || student.justify}
                            onClick={(e) => handleSendEmailToStudent(e, student.studentId)}
                            component="a"
                          >
                            <Send fontSize="small" />
                          </IconButton>
