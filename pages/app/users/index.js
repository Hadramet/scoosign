import { Box, Button, Container, Typography, Divider, Grid, Card, Tabs, Tab, TextField, InputAdornment } from "@mui/material";
            ...
            <Box component="main"
                ...
                <Container maxWidth='xl'>
                    <Box sx={{ mb: 4 }}>
                        ...
                        <Box sx={{ m: -1, mt: 3 }}>
                            <Button startIcon={<UploadIcon fontSize="small" />} sx={{ m: 1 }}> Import</Button>
                            <Button startIcon={<DownloadIcon fontSize="small" />} sx={{ m: 1 }}> Export</Button>
                        </Box>
                    </Box>
                    ...
                    <Card>
                        ...
                        <Box sx={{ alignItems: 'center', display: 'flex', flexWrap: 'wrap', m: -1.5, p: 3 }}>
                            <Box component="form" onSubmit={handleQueryChange} sx={{ flexGrow: 1, m: 1.5 }}>
                                <TextField defaultValue="" fullWidth inputProps={{ ref: queryRef }} InputProps={{
                                    startAdornment: (
